...
## Environments
- Preview: https://main--nissan-eds-poc--nimithshetty.aem.page/
- Live: https://main--nissan-eds-poc--nimithshetty.aem.live/
...
1. Open the `nissan-eds-poc` directory in your favorite IDE and start coding :)
